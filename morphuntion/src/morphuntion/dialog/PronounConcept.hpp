 ...
 */
class MORPHUNTION_CLASS_API morphuntion::dialog::PronounConcept
...
private: /* protected */
    ...
    const PronounEntry* getFirstPossibleValue(const morphuntion::dialog::SemanticFeatureConceptBase* referencedConcept, bool returnDefault, bool matchAll) const;
    const PronounEntry* getCurrentValue(const morphuntion::dialog::SemanticFeatureConceptBase* referencedConcept, bool returnDefault, bool matchAll) const;
...
public:
     ...
     * @return null when the constrained values is an empty set.
     */
    virtual ::morphuntion::dialog::SpeakableString* toSpeakableString(const morphuntion::dialog::SemanticFeatureConceptBase& referencedConcept) const;
     ...
     */
    PronounConcept(const SemanticFeatureModel& model, const ::std::vector<::morphuntion::dialog::SemanticFeatureModel_DisplayValue>& defaultDisplayData, const ::std::map<SemanticFeature, ::std::u16string>& defaultConstraints);
