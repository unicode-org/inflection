...
static std::string deriveSourceText(const ::std::vector<::std::u16string>& tokens) {
    ...
    for (const auto& token : tokens) {
        ...
        result += morphuntion::util::StringUtils::to_string(token);
    }
    return result;
}

void compareTokens(::morphuntion::tokenizer::TokenChain* tokChainLocal, const std::string& locale, bool compareClean, const ::std::vector<::std::u16string>& expectedResults)
{
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tokChain(tokChainLocal);
    if (int32_t(expectedResults.size()) != tokChain->getSize()) {
        std::string msg("Got: " + morphuntion::util::StringUtils::to_string(tokChain->toString())
        ...
        for (auto tok = tokChain->begin(); tok != tokChain->end(); ++tok) {
            ...
            if (comparisonResult != 0) {
                std::string msg("Got: " + morphuntion::util::StringUtils::to_string(tokChain->toString())
                                + "\nExpected: " + deriveSourceText(expectedResults)
                                + "\nToken: -> " + morphuntion::util::StringUtils::to_string(expectedResults[resultsIdx]) + " != " + morphuntion::util::StringUtils::to_string(value));
                if (!locale.empty()) {
...
void compareValueTokens(::morphuntion::tokenizer::TokenChain* tokChain, const ::std::vector<::std::u16string>& expectedResults)
{
    compareTokens(tokChain, {}, false, expectedResults);
}

void compareCleanTokens(::morphuntion::tokenizer::TokenChain* tokChain, const ::std::vector<::std::u16string>& expectedResults)
{
...
TEST_CASE("TokenizerTest#testDefault")
{
    ...
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::ULocale("zz")));
    REQUIRE((stringLogger.logLines.size() == 1 || stringLogger.logLines.size() == 2));
    INFO(morphuntion::util::StringUtils::to_string(stringLogger.logLines[0]));
    ...
    if (stringLogger.logLines.size() == 2) {
        ...
        INFO(morphuntion::util::StringUtils::to_string(stringLogger.logLines[1]));
        CHECK(morphuntion::util::StringViewUtils::startsWith(stringLogger.logLines[1], u"[INFO] [Tokenizer] The tokenizer for zz is being constructed for the first time. Platform="));
    }
...
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(morphuntion::util::LocaleUtils::ENGLISH()));
    ...
    CHECK(result.find(u"morphuntion") != std::u16string::npos);
}

TEST_CASE("TokenizerTest#testAliases")
{
    std::vector<morphuntion::util::ULocale> locales({{"iw"}, {"id"}, {"no"}, {"cmn_Hans_CN@sd=cnsc"},
                                                 {morphuntion::util::LocaleUtils::INDONESIA()},
                                                 {morphuntion::util::LocaleUtils::SHANGHAINESE()},
                                                 {morphuntion::util::LocaleUtils::CHINA_SHANGHAINESE()},
                                                 {morphuntion::util::LocaleUtils::SIMPLIFIED_CHINESE()},
    });
    for (const auto& locale : locales) {
        ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(locale));
        compareValueTokens(tokenizer->createTokenChain(u"Hello world!"), {u"", u"Hello", u" ", u"world", u"!", u""});
    }
}
...
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::US()));
...
bool isSignificant(::morphuntion::tokenizer::TokenChain* tokChain, int32_t index)
{
...
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::FRENCH()));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tokenChain(tokenizer->createTokenChain(u"1 + 1"));
...
TEST_CASE("TokenizerTest#testWhiteSpaces")
{
    ...
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tk(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::US()));
    ...
    for (::std::u16string whitespace : whitespaces) {
        ...
        REQUIRE(dynamic_cast< ::morphuntion::tokenizer::Token_Delim* >(npc(npc(tokenChain)->getHead())->getNext()) != nullptr);
    ...
    REQUIRE(dynamic_cast< ::morphuntion::tokenizer::Token_Delim* >(npc(npc(npc(tokenChain)->getHead())->getNext())->getNext()) != nullptr);
    ...
    REQUIRE(dynamic_cast< ::morphuntion::tokenizer::Token_Delim* >(npc(npc(npc(npc(tokenChain)->getHead())->getNext())->getNext())->getNext()) != nullptr);
...
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tk(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::FRENCH()));
    auto tokenChain = tk->createTokenChain(u"\u00E1 la maison");
    REQUIRE(dynamic_cast< ::morphuntion::tokenizer::Token_Word* >(npc(npc(tokenChain)->getHead())->getNext()) != nullptr);
    REQUIRE(dynamic_cast< ::morphuntion::tokenizer::Token_Delim* >(npc(npc(npc(tokenChain)->getHead())->getNext())->getNext()) != nullptr);
...
TEST_CASE("TokenizerTest#testModifiers")
{
    ...
    tokenizer->setStyle(morphuntion::tokenizer::Tokenizer::TokenizationType::UNMODIFIED);
    compareValueTokens(tokenizer->createTokenChain(u"9AM HAL9000"), {u"", u"9AM", u" ", u"HAL9000", u""});
}

void checkSingleToken(::morphuntion::tokenizer::Tokenizer* tokenizer, const std::string& locale, const ::std::u16string& annotatedTokens)
{
    ::std::u16string input;
    morphuntion::util::StringViewUtils::replace(&input, annotatedTokens, u"|", u"");
    auto tokenChain = npc(tokenizer)->createTokenChain(input);
    auto expected = morphuntion::util::StringViewUtils::split(annotatedTokens, u"|");
...
void checkSingleToken(const ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer>& tokenizer, const ::std::u16string& annotatedTokens)
{
...
TEST_CASE("TokenizerTest#testSingleToken")
{
    ...
    for (const auto& file : files) {
        ...
        if (tokenizerTest == nullptr) {
            throw ::morphuntion::exception::XMLParseException(u"Incorrect root element -- expecting <tokenizerTest>, got <null>");
        }

        ::std::string locale = file.substr(0, file.length() - ::std::string(".xml").length());
        ::morphuntion::util::ULocale ulocale(locale);

        if (testLocales.find(ulocale.getLanguage()) == testLocales.end()) {
            continue;
        }

        ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(ulocale));
        ...
        for (xmlNodePtr currTestNode = tokenizerTest->children; currTestNode != nullptr; currTestNode = currTestNode->next) {
            ...
            if (xmlStrEqual(testCaseNode->name, (const xmlChar *) "annotatedTokens") == 0) {
                throw ::morphuntion::exception::XMLParseException(u"Expecting element <annotatedTokens>, got <" + ::morphuntion::util::StringUtils::to_u16string(std::string(reinterpret_cast<const char*>(testCaseNode->name))) + u">");
            }
...
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> englishTok(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::US()));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tok(englishTok->createTokenChain(u"IΣΣ9"));
    ...
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> turkishTok(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::TURKISH()));
...
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> englishTok(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::US()));
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> frenchTok(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::FRANCE()));
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> germanTok(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::GERMANY()));
    ...
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tokenChain;
    tokenChain.reset(germanTok->createTokenChain(u"1-1"));
    REQUIRE(dynamic_cast< ::morphuntion::tokenizer::Token_Word* >(tokenChain->getToken(1)) != nullptr);
    tokenChain.reset(germanTok->createTokenChain(u":-)"));
    REQUIRE(dynamic_cast< ::morphuntion::tokenizer::Token_Word* >(tokenChain->getToken(1)) != nullptr);
    tokenChain.reset(germanTok->createTokenChain(u"-1"));
    REQUIRE(dynamic_cast< ::morphuntion::tokenizer::Token_Word* >(tokenChain->getToken(0)) != nullptr);
    tokenChain.reset(germanTok->createTokenChain(u"-a"));
    REQUIRE(dynamic_cast< ::morphuntion::tokenizer::Token_Word* >(tokenChain->getToken(0)) != nullptr);
    tokenChain.reset(germanTok->createTokenChain(u"1-"));
    REQUIRE(dynamic_cast< ::morphuntion::tokenizer::Token_Word* >(tokenChain->getToken(1)) != nullptr);
    tokenChain.reset(germanTok->createTokenChain(u"a-"));
    REQUIRE(dynamic_cast< ::morphuntion::tokenizer::Token_Delim* >(tokenChain->getToken(1)) != nullptr);
    ...
    REQUIRE(dynamic_cast< ::morphuntion::tokenizer::Token_Word* >(tokenChain->getToken(8)) != nullptr);
    tokenChain.reset(germanTok->createTokenChain(u"What is 1 - 1"));
    REQUIRE(dynamic_cast< ::morphuntion::tokenizer::Token_Word* >(tokenChain->getToken(10)) != nullptr);
}

TEST_CASE("TokenizerTest#testItalianTokenizer")
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::ITALIAN()));
    compareValueTokens(tokenizer->createTokenChain(u"po’ l’ora"), {u"", u"po", u"’", u" ", u"l", u"’", u"ora", u""});
}

TEST_CASE("TokenizerTest#testArabic")
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::ARABIC()));
...
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> hebTok(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::HEBREW()));
...
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::ENGLISH()));
    tokenizer->setStyle(morphuntion::tokenizer::Tokenizer::DEFAULT);
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tokChain(tokenizer->createTokenChain(u"I have an explicit ^key^=^value^! OVERSIZED_TOKEN"));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> cloneChain(tokChain->getNewTokenChain(tokChain->getHead()->getStartChar(), tokChain->getTail()->getEndChar()));
    if (cloneChain->getSize() != tokChain->getSize()) {
        INFO(morphuntion::util::StringUtils::to_string(tokChain->toString()));
    }
    ...
    for (; tok != tokEnd && cloneTok != cloneTokEnd; ++tok, ++cloneTok) {
        ...
        if (!comparisonResult) {
            INFO(morphuntion::util::StringUtils::to_string(tokChain->toString() + u" -> " + tok->getValue() + u" != " + cloneTok->getValue()));
        }
...
TEST_CASE("TokenizerTest#testLocaleCoverage")
{
    ...
    for (const auto& entry : TestUtils::getTestLocaleMap()) {
        morphuntion::util::ULocale language(entry.first);
        ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(language));
        ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tokChain(tokenizer->createTokenChain(language.toString()));
        for (const auto& locale : entry.second) {
            ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizerLocale(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(locale));
            ...
            ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tokChainLocale(tokenizer->createTokenChain(displayName));
...
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> english(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::ULocale("en_US@calendar=japanese")));
    checkSingleToken(english, u"Hello| |world|!");
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> sichuanese(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::ULocale("cmn_Hans_CN@sd=cnsc")));
    checkSingleToken(sichuanese, u"Hello| |world|!");
}

TEST_CASE("TokenizerTest#testLongText")
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tok(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::TRADITIONAL_CHINESE()));
...
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::ENGLISH()));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tokChain(tokenizer->createTokenChain(u"a b c d e f"));
