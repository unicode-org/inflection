 ...
 */
class MORPHUNTION_CLASS_API morphuntion::dialog::NumberConcept
...
private:
    ...
    ::morphuntion::util::ULocale regionLocale;
...
private:
    static int64_t longValue(const ::morphuntion::dialog::NumberConcept::Number& value);
    static double doubleValue(const ::morphuntion::dialog::NumberConcept::Number& value);
...
//    static ::morphuntion::dialog::NumberConcept::Number toSmallestPrimitiveType(const ::morphuntion::dialog::NumberConcept::Number& value);
...
public:
     ...
     */
    virtual const ::morphuntion::util::ULocale& getLanguage() const;

    /**
     * Returns the locale used to format the printable part of a SpeakableString.
     */
    virtual const ::morphuntion::util::ULocale& getRegionLocale() const;
...
private:
    ::icu4cxx::NumberFormat createSimpleNumberFormat(const ::morphuntion::util::ULocale& locale) const;
...
public:
     ...
     */
    NumberConcept(int64_t value, const ::morphuntion::util::ULocale& language, const ::morphuntion::util::ULocale& regionLocale);
    /**
     * Construct a NumberConcept.
     ...
     * @param regionLocale This locale is primarily used for the print property of a SpeakableString.
     */
    NumberConcept(double value, const ::morphuntion::util::ULocale& language, const ::morphuntion::util::ULocale& regionLocale);
    /**
     * Copy constructor
     */
