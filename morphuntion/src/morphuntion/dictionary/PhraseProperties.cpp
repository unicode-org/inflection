...
{
    static auto DEFAULT_VOWELS_START_ = ::morphuntion::util::UnicodeSetUtils::freeze(::morphuntion::util::UnicodeSetUtils::closeOver(
...
{
    static auto FRENCH_VOWELS_START_ = ::morphuntion::util::UnicodeSetUtils::freeze(::morphuntion::util::UnicodeSetUtils::closeOver(
...
{
    static auto DEFAULT_VOWELS_END_ = ::morphuntion::util::UnicodeSetUtils::freeze(::morphuntion::util::UnicodeSetUtils::closeOver(
...
{
    static auto I_LETTER_ = ::morphuntion::util::UnicodeSetUtils::freeze(::morphuntion::util::UnicodeSetUtils::closeOver(npc(new ::icu4cxx::UnicodeSet(u"[i]")), USET_CASE_INSENSITIVE));
    return *npc(I_LETTER_);
}

const icu4cxx::UnicodeSet& PhraseProperties::J_LETTER()
{
    static auto J_LETTER_ = ::morphuntion::util::UnicodeSetUtils::freeze(::morphuntion::util::UnicodeSetUtils::closeOver(npc(new ::icu4cxx::UnicodeSet(u"[j]")), USET_CASE_INSENSITIVE));
    return *npc(J_LETTER_);
}

const icu4cxx::UnicodeSet& PhraseProperties::DEFAULT_MATCHABLE_SET()
{
    static auto DEFAULT_MATCHABLE_SET_ = ::morphuntion::util::UnicodeSetUtils::freeze(npc(new ::icu4cxx::UnicodeSet(u"[[:Letter:][:Decimal_Number:]]")));
    return *npc(DEFAULT_MATCHABLE_SET_);
}

const ::icu4cxx::UnicodeSet& PhraseProperties::PUNCTUATION()
{
    static auto PUNCTUATION_ = ::morphuntion::util::UnicodeSetUtils::freeze(new ::icu4cxx::UnicodeSet(u"[[[:punctuation:][:symbol:]]-[\\&]]"));
    return *npc(PUNCTUATION_);
}

const icu4cxx::UnicodeSet& PhraseProperties::SINGLE_QUOTES()
{
    static auto SINGLE_QUOTES_ = ::morphuntion::util::UnicodeSetUtils::freeze(new ::icu4cxx::UnicodeSet(u"[ʼ‘’‛׳]"));
...
bool PhraseProperties::isStartsWithVowel(const ::morphuntion::util::ULocale& loc, ::std::u16string_view str)
{
    ...
    if (::morphuntion::util::LocaleUtils::FRENCH() == lang) {
        if (wordTypes != 0 && morphuntion::util::StringViewUtils::startsWith(str, u"H")) {
...
bool PhraseProperties::isEndsWithVowel(const ::morphuntion::util::ULocale& loc, ::std::u16string_view str)
{
    const auto& lang = loc.getLanguage();
    auto matchableSubset = PhraseProperties::DEFAULT_VOWELS_END();
    const auto &dictionary = *npc(DictionaryMetaData::createDictionary(loc));
    ::std::u16string strippedStr;
    ::morphuntion::util::UnicodeSetUtils::removeSetFromString(&strippedStr, PUNCTUATION(), str);
    int64_t vowelProperty = 0;
    int64_t consonantProperty = 0;
    ...
    if (::morphuntion::util::LocaleUtils::TURKISH().getLanguage() == lang) {
        matchableSubset = DEFAULT_VOWELS_START();
    }
    else if (::morphuntion::util::LocaleUtils::DUTCH().getLanguage() == lang
...
bool PhraseProperties::isStartsWithUnicodeSets(::std::u16string_view str, const ::icu4cxx::UnicodeSet& importantSet, const ::icu4cxx::UnicodeSet& matchableSubset, const ::std::vector<const ::icu4cxx::UnicodeSet*>&/*...*/ matchableSubsets)
{
    ...
    if (index >= 0) {
        if (matchableSubsets.empty()) {
            ...
            ::morphuntion::util::StringUtils::appendCodePoint(&codePoint, ::morphuntion::util::StringViewUtils::codePointAt(str, index));
            auto firstChar = normalize(NFKD(), codePoint);
            return matchableSubset.contains(::morphuntion::util::StringViewUtils::codePointAt(firstChar, 0));
        } else {
            if (!matchableSubset.contains(::morphuntion::util::StringViewUtils::codePointAt(str, index))) {
                return false;
            }
            ...
            for (index++; iterator != matchableSubsets.cend() && index < strLen; index++) {
                if (!npc(*(iterator++))->contains(::morphuntion::util::StringViewUtils::codePointAt(str, index))) {
                    return false;
                }
            }
...
bool PhraseProperties::isEndsWithUnicodeSets(::std::u16string_view str, const ::icu4cxx::UnicodeSet& importantSet, const ::icu4cxx::UnicodeSet& matchableSubset, const ::std::vector<const ::icu4cxx::UnicodeSet*>&/*...*/ matchableSubsets)
{
    ...
    if (index >= 0) {
        if (matchableSubsets.empty()) {
            ...
            if (index >= 0) {
                return matchableSubset.contains(::morphuntion::util::StringViewUtils::codePointAt(lastChar, index));
            }
        } else {
            ...
            if (index >= 0 && matchableSubset.contains(::morphuntion::util::StringViewUtils::codePointAt(str, index))) {
                return true;
            }
        }
    }
...
int32_t PhraseProperties::getFirstUsableIndex(::std::u16string_view str, const ::icu4cxx::UnicodeSet& importantSet)
{
    if (!str.empty()) {
        ...
        for (int32_t firstUsableIdx = 0; firstUsableIdx < strLen; firstUsableIdx++) {
            if (importantSet.contains(::morphuntion::util::StringViewUtils::codePointAt(str, firstUsableIdx))) {
...
int32_t PhraseProperties::getLastUsableIndex(::std::u16string_view str, const ::icu4cxx::UnicodeSet& importantSet)
{
    if (!str.empty()) {
        for (int32_t lastUsableIndex = int32_t(str.length() - 1); lastUsableIndex >= 0; lastUsableIndex--) {
            if (importantSet.contains(::morphuntion::util::StringViewUtils::codePointAt(str, lastUsableIndex))) {
