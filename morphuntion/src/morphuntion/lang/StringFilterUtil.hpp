...
#include <morphuntion/lang/fwd.hpp>
 ...
 */
class MORPHUNTION_INTERNAL_API morphuntion::lang::StringFilterUtil final
{
public:
...
public:
     ...
     */
    static const ::icu4cxx::UnicodeSet& getExemplarCharacters(const ::morphuntion::util::ULocale& locale);

public:
    /**
     * Returns the set of characters that can be modified by an NFD normalization and are foreign to a given language.
     */
    static const ::icu4cxx::UnicodeSet& getNfdVolatileForeignExemplarCharacters(const ::morphuntion::util::ULocale& locale);
    /**
     * Removes all diacritics (accents) from a string that are foreign to a language.
     */
    static ::std::u16string stripNonNativeAccents(const ::morphuntion::util::ULocale& locale, const ::std::u16string& str);
    /**
    ...
    static bool equalIgnoreCaseAndAllAccents(::std::u16string_view s1, ::std::u16string_view s2, const ::morphuntion::util::ULocale& locale);
    /**
