...
using ::morphuntion::util::Logger;

DictionaryLookupInflector::DictionaryLookupInflector(const ::morphuntion::util::ULocale &locale, const std::vector<::std::vector<std::u16string_view>> &propertyPrioritiesData, const ::std::vector<::std::vector<::std::u16string>> &ignoreGrammemeSets, bool enableDictionaryFallback)
...
inline void traceLogInflectCall(const std::u16string &funcName, std::u16string_view word, const std::vector<::std::u16string> &constraints, const std::vector<std::u16string> &optionalConstraints, const std::vector<::std::u16string> &disambiguationGrammemeValues) {
    Logger::trace(funcName + u"("
        ...
        + u"constraints = [" + morphuntion::util::StringViewUtils::join(constraints, u", ") + u"], "
        + u"optionalConstraints = [" + morphuntion::util::StringViewUtils::join(optionalConstraints, u", ") + u"], "
        + u"disambiguationGrammemeValues = [" + morphuntion::util::StringViewUtils::join(disambiguationGrammemeValues, u", ") + u"]"
        + u")\n");
}

inline void traceLogSortedInflectionGrammemes(const ::std::vector<::morphuntion::analysis::DictionaryExposableMorphology::InflectionGrammemes> &inflectionGrammemes, const ::std::vector<int64_t> &inflectionCandidates, const dictionary::DictionaryMetaData& dictionary) {
...
::std::optional<::std::u16string> DictionaryLookupInflector::inflectWordImplementation(std::u16string_view word, const std::vector<::std::u16string> &constraints, const std::vector<std::u16string> &optionalConstraints, const std::vector<::std::u16string> &disambiguationGrammemeValues) const {
    ...
    ::std::vector<::morphuntion::analysis::DictionaryExposableMorphology::InflectionGrammemes> inflectionGrammemes;
    ...
    for (const auto &inflectionCandidateIdx : inflectionCandidates) {
        ...
        if (LoggerConfig::isTraceEnabled()) {
            Logger::trace(std::u16string(u"reinflect function called:\n\targs:")
                          ...
                          + std::u16string(word)
                          + u"\n\t\tinflectionGrammemes: "
                          + morphuntion::util::StringViewUtils::join(dictionary.getPropertyNames(inflection.getGrammemes()), u", ")
                          + u"\n\t\tconstraints: "
                          + morphuntion::util::StringViewUtils::join(constraints, u", ")
                          + u"\n\t\toptionalConstraints: "
                          + morphuntion::util::StringViewUtils::join(optionalConstraints, u", ")
                          + u"\n");
        }
...
::std::optional<::std::u16string> DictionaryLookupInflector::inflectImplementation(std::u16string_view word, const std::vector<::std::u16string> &constraints, const std::vector<std::u16string> &optionalConstraints, const std::vector<::std::u16string> &disambiguationGrammemeValues) const {
    ...
    const bool allCaps = morphuntion::util::StringViewUtils::isAllUpperCase(word);
    ...
    ::morphuntion::util::StringViewUtils::lowercase(&lowerCasedWord, word, locale);
    ...
    if (inflectedWord.has_value()) {
        ...
        if (allCaps) {
            ...
            ::morphuntion::util::StringViewUtils::uppercase(&upperCaseInflectedWord, *inflectedWord, locale);
            inflectedWord = upperCaseInflectedWord;
        } else if ((bool)u_isupper((UChar32) ::morphuntion::util::StringViewUtils::codePointAt(word, 0))) {
            //If word is capitalized first then inflection is capitalized first
            inflectedWord = morphuntion::util::StringViewUtils::capitalizeFirst(*inflectedWord, locale);
        }
        return inflectedWord;
    }
    return {};
...
int64_t DictionaryLookupInflector::compareInflectionGrammemes(const ::morphuntion::analysis::DictionaryExposableMorphology::InflectionGrammemes &inflectionGrammemes1, const ::morphuntion::analysis::DictionaryExposableMorphology::InflectionGrammemes &inflectionGrammemes2, const std::vector<int64_t> &disambiguationGrammemes) const {
