...
template <typename T>
class morphuntion::dictionary::metadata::MarisaTrieIterator
{
...
private:
    ...
    const ::morphuntion::dictionary::metadata::MarisaTrie<T>& trie;
    ::marisa::Agent agent;
    ::std::u16string prefix;
    ::std::pair<::std::u16string, T> value {  };
    bool reachedEnd { false };

    friend class morphuntion::dictionary::DictionaryKeyIterator;
};

template <typename T>
const ::std::pair<::std::u16string, T>&
morphuntion::dictionary::metadata::MarisaTrieIterator<T>::operator*() {
    if (reachedEnd) {
        value = {u"", {}};
    }
    else {
...
template <typename T>
bool
morphuntion::dictionary::metadata::MarisaTrieIterator<T>::operator==(const MarisaTrieIterator& rhs) const {
...
template <typename T>
morphuntion::dictionary::metadata::MarisaTrieIterator<T>
morphuntion::dictionary::metadata::MarisaTrieIterator<T>::begin() const
{
...
template <typename T>
morphuntion::dictionary::metadata::MarisaTrieIterator<T>
morphuntion::dictionary::metadata::MarisaTrieIterator<T>::end() const
{
