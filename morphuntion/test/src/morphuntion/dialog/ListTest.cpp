...
static const morphuntion::dialog::CommonConceptFactory* getCommonConceptFactory(const morphuntion::util::ULocale& locale) {
    return npc(npc(::morphuntion::dialog::LocalizedCommonConceptFactoryProvider::getDefaultCommonConceptFactoryProvider())->getCommonConceptFactory(locale));
}

static ::std::vector<morphuntion::dialog::SemanticFeatureConceptBase*> toConcepts(const ::morphuntion::dialog::SemanticFeatureModel* model, const ::std::vector<::std::u16string>& strings)
{
    ::std::vector<morphuntion::dialog::SemanticFeatureConceptBase*> concepts;
    concepts.reserve(strings.size());
    for (const auto& string : strings) {
        concepts.emplace_back(new ::morphuntion::dialog::InflectableStringConcept(model, morphuntion::dialog::SpeakableString(string)));
    }
    return concepts;
}

static ::std::vector<morphuntion::dialog::SemanticFeatureConceptBase*> toConcepts(const ::morphuntion::dialog::SemanticFeatureModel* model, const ::std::vector<::morphuntion::dialog::SpeakableString>& strings)
{
    ::std::vector<morphuntion::dialog::SemanticFeatureConceptBase*> concepts;
    concepts.reserve(strings.size());
    for (const auto& string : strings) {
        concepts.emplace_back(new ::morphuntion::dialog::InflectableStringConcept(model, string));
    }
    return concepts;
}

static ::std::u16string andList(const morphuntion::dialog::CommonConceptFactory* conceptFactory, const ::std::vector<::std::u16string>& args)
{
    ::std::vector<morphuntion::dialog::SemanticFeatureConceptBase*> concepts(toConcepts(npc(conceptFactory)->getSemanticFeatureModel(), args));
    morphuntion::dialog::SemanticConceptList* andConceptList = npc(conceptFactory)->createAndList(concepts);
...
static ::std::u16string andHonorificList(const morphuntion::dialog::CommonConceptFactory* conceptFactory, const ::std::u16string& honorific, const ::std::vector<::std::u16string>& args)
{
    ::std::vector<morphuntion::dialog::SemanticFeatureConceptBase*> concepts(toConcepts(npc(conceptFactory)->getSemanticFeatureModel(), args));
    auto andConceptList = npc(conceptFactory)->createAndList(concepts);
    npc(andConceptList)->setItemSuffix(morphuntion::dialog::SpeakableString(honorific));
    auto speakableResult = npc(andConceptList)->toSpeakableString();
    ::std::u16string result;
    if (speakableResult != nullptr) {
        result = npc(speakableResult)->getPrint();
...
static ::std::u16string orList(const morphuntion::dialog::CommonConceptFactory* conceptFactory, const ::std::vector<::std::u16string>& args)
{
    ::std::vector<morphuntion::dialog::SemanticFeatureConceptBase*> concepts(toConcepts(npc(conceptFactory)->getSemanticFeatureModel(), args));
    morphuntion::dialog::SemanticConceptList* andConceptList = npc(conceptFactory)->createOrList(concepts);
    auto speakableResult = npc(andConceptList)->toSpeakableString();
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::SPANISH());
    ...
    REQUIRE(*npc(speakableValue) == morphuntion::dialog::SpeakableString(u"gato, gata, gatos y gatas"));

    delete speakableValue;
    speakableValue = npc(andListSpeakable)->getFeatureValueByName(u"gender");
    REQUIRE(*npc(speakableValue) == morphuntion::dialog::SpeakableString(u"masculine"));

    delete speakableValue;
    speakableValue = npc(andListSpeakable)->getFeatureValueByName(u"withDePrepArticle");
    REQUIRE(*npc(speakableValue) == morphuntion::dialog::SpeakableString(u"del gato, de la gata, de los gatos y de las gatas"));

    delete andListSpeakable;
    delete speakableValue;
    andListSpeakable = npc(factory)->createAndList(::std::vector<const ::morphuntion::dialog::SemanticFeatureConceptBase*>({inputElements[0], inputElements[1]}));
    npc(andListSpeakable)->putConstraintByName(u"number", u"plural");
    speakableValue = npc(andListSpeakable)->toSpeakableString();
    REQUIRE(*npc(speakableValue) == morphuntion::dialog::SpeakableString(u"gatos y gatas"));
    npc(andListSpeakable)->reset();
    delete speakableValue;
    speakableValue = npc(andListSpeakable)->toSpeakableString();
    REQUIRE(*npc(speakableValue) == morphuntion::dialog::SpeakableString(u"gato y gata"));
    npc(andListSpeakable)->putConstraintByName(u"number", u"plural");
    delete speakableValue;
    speakableValue = npc(andListSpeakable)->toSpeakableString();
    REQUIRE(*npc(speakableValue) == morphuntion::dialog::SpeakableString(u"gatos y gatas"));
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::ENGLISH());
    ...
    REQUIRE(*npc(speakableValue) == morphuntion::dialog::SpeakableString(u"a, b, c, and d"));

    npc(andList)->setBeforeFirst(morphuntion::dialog::SpeakableString(u"1"));
    npc(andList)->setItemPrefix(morphuntion::dialog::SpeakableString(u"2"));
    npc(andList)->setItemSuffix(morphuntion::dialog::SpeakableString(u"3"));
    npc(andList)->setAfterFirst(morphuntion::dialog::SpeakableString(u"4"));
    npc(andList)->setItemDelimiter(morphuntion::dialog::SpeakableString(u"5"));
    npc(andList)->setBeforeLast(morphuntion::dialog::SpeakableString(u"6"));
    npc(andList)->setAfterLast(morphuntion::dialog::SpeakableString(u"7"));

    delete speakableValue;
    speakableValue = npc(andList)->toSpeakableString();
    REQUIRE(*npc(speakableValue) == morphuntion::dialog::SpeakableString(u"12a342b352c362d37"));
    REQUIRE(npc(andList)->toString() == u"[a, b, c, d]");

    npc(andList)->setAfterFirst(morphuntion::dialog::SpeakableString(u""));
    npc(andList)->setBeforeLast(morphuntion::dialog::SpeakableString(u""));

    delete speakableValue;
    speakableValue = npc(andList)->toSpeakableString();
    REQUIRE(*npc(speakableValue) == morphuntion::dialog::SpeakableString(u"12a352b352c352d37"));
    REQUIRE(npc(andList)->isExists());

    delete andList;
    andList = npc(factory)->createAndList(::std::vector<const ::morphuntion::dialog::SemanticFeatureConceptBase*>());
    npc(andList)->setBeforeFirst(morphuntion::dialog::SpeakableString(u"1"));
    npc(andList)->setItemPrefix(morphuntion::dialog::SpeakableString(u"2"));
    npc(andList)->setItemSuffix(morphuntion::dialog::SpeakableString(u"3"));
    npc(andList)->setAfterFirst(morphuntion::dialog::SpeakableString(u"4"));
    ...
    delete andList;
    delete speakableValue;
    andList = npc(factory)->createAndList(::std::vector<const ::morphuntion::dialog::SemanticFeatureConceptBase*>({inputElements[0]}));
    npc(andList)->setBeforeFirst(morphuntion::dialog::SpeakableString(u"1"));
    npc(andList)->setItemPrefix(morphuntion::dialog::SpeakableString(u"2"));
    npc(andList)->setItemSuffix(morphuntion::dialog::SpeakableString(u"3"));
    npc(andList)->setAfterFirst(morphuntion::dialog::SpeakableString(u"4"));
    ...
    npc(andList)->setAfterLast(morphuntion::dialog::SpeakableString(u"7"));
    speakableValue = npc(andList)->toSpeakableString();
    REQUIRE(*npc(speakableValue) == morphuntion::dialog::SpeakableString(u"12a37"));

    delete andList;
    delete speakableValue;
    andList = npc(factory)->createAndList(::std::vector<const ::morphuntion::dialog::SemanticFeatureConceptBase*>({inputElements[0], inputElements[1]}));
    npc(andList)->setBeforeFirst(morphuntion::dialog::SpeakableString(u"1"));
    npc(andList)->setItemPrefix(morphuntion::dialog::SpeakableString(u"2"));
    npc(andList)->setItemSuffix(morphuntion::dialog::SpeakableString(u"3"));
    npc(andList)->setAfterFirst(morphuntion::dialog::SpeakableString(u"4"));
    ...
    npc(andList)->setAfterLast(morphuntion::dialog::SpeakableString(u"7"));
    speakableValue = npc(andList)->toSpeakableString();
    REQUIRE(*npc(speakableValue) == morphuntion::dialog::SpeakableString(u"12a3462b37"));
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::US());
    auto one = morphuntion::dialog::NumberConcept((int64_t)1, morphuntion::util::LocaleUtils::US(), morphuntion::util::LocaleUtils::US()).toSpeakableString();
    auto two = morphuntion::dialog::NumberConcept((int64_t)2, morphuntion::util::LocaleUtils::US(), morphuntion::util::LocaleUtils::US()).toSpeakableString();
    auto three = morphuntion::dialog::NumberConcept((int64_t)3, morphuntion::util::LocaleUtils::US(), morphuntion::util::LocaleUtils::US()).toSpeakableString();
    auto four = morphuntion::dialog::NumberConcept((int64_t)4, morphuntion::util::LocaleUtils::US(), morphuntion::util::LocaleUtils::US()).toSpeakableString();
...
TEST_CASE("ListTest#testSpeakAndValueEn")
{
    ...
    auto inputElements = toConcepts(npc(factory)->getSemanticFeatureModel(), {
            morphuntion::dialog::SpeakableString(u"1", u"one"),
            morphuntion::dialog::SpeakableString(u"2", u"two"),
            morphuntion::dialog::SpeakableString(u"3", u"three")});
    ...
    morphuntion::dialog::SpeakableString expectedSpeakable(expectedPrint, expectedSpeak);
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::GERMANY());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::FRANCE());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::THAILAND());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::SAUDI_ARABIA());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::ISRAEL());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::JAPAN());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::SPAIN_SPANISH());
...
TEST_CASE("ListTest#testListDirectFromCommonConceptFactoryProvider")
{
    ...
    morphuntion::dialog::LocalizedCommonConceptFactoryProvider provider;
    auto factory = provider.getCommonConceptFactory(morphuntion::util::LocaleUtils::MEXICO_SPANISH());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::ITALY());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::KOREA());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::CHINA());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::HONGKONG_CHINESE());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::SWEDISH());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::NORWEGIAN());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::DANISH());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::PORTUGUESE());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::DUTCH());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::MALAY());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::INDONESIAN());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::TURKISH());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::RUSSIAN());
...
{
    auto factory = getCommonConceptFactory(morphuntion::util::LocaleUtils::HINDI());
...
TEST_CASE("ListTest#testClone")
{
    ...
    for (const auto& localeEntry : ::morphuntion::util::LocaleUtils::getSupportedLocaleMap()) {
        morphuntion::util::ULocale locale(localeEntry.first);
        const morphuntion::dialog::CommonConceptFactory* conceptFactory = nullptr;
        ...
        const ::morphuntion::dialog::SemanticFeatureModel* model = npc(conceptFactory)->getSemanticFeatureModel();

        ::std::vector<morphuntion::dialog::SemanticFeatureConceptBase*> concepts(toConcepts(model, list));
        morphuntion::dialog::SemanticConceptList* andConceptList = npc(conceptFactory)->createAndList(concepts);
        if (canBePlural) {
            npc(andConceptList)->putConstraintByName(u"number", u"plural");
        }
        npc(andConceptList)->setItemPrefix(morphuntion::dialog::SpeakableString(u"prefix "));
        auto speakableResult = npc(andConceptList)->toSpeakableString();

        morphuntion::dialog::SemanticConceptList* andConceptListClone = npc(andConceptList)->clone();
        ...
        morphuntion::dialog::SemanticConceptList* orConceptList = npc(conceptFactory)->createOrList(concepts);
        if (canBePlural) {
            npc(orConceptList)->putConstraintByName(u"number", u"plural");
        }
        npc(orConceptList)->setItemPrefix(morphuntion::dialog::SpeakableString(u"prefix "));
        speakableResult = npc(orConceptList)->toSpeakableString();

        morphuntion::dialog::SemanticConceptList* orConceptListClone = npc(orConceptList)->clone();
