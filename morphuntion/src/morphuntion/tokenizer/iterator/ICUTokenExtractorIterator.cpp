...
static UBreakIterator* checkoutCachedTokenizer()
{
    ...
    if (tokenizer == nullptr) {
        throw ::morphuntion::exception::InvalidConfigurationException(u"BreakIterator returned null. Perhaps the data files could not be found.");
    }
...
namespace morphuntion::tokenizer::iterator {
