...
public:
    ...
    static constexpr int64_t VERSION { 4 }; // Bump this version if the binary file format changes.
...
private:
    ...
    inflection::dictionary::metadata::StringContainer inflectionPrefixes;
