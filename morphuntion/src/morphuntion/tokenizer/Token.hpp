...
#include <morphuntion/tokenizer/CharRange.hpp>
#include <string_view>
 ...
 *
 * The Token object provides the foundational blocks of the main aspects of Morphuntion's functionalities, including
 ...
 * performed by Morphuntion. This is retrievable using the getValue() function.
 *
 * <h3> Clean value </h3>
 * This represents the value of the Token after normalization, lemmatization, decompounding, or any other filtering
 * performed by Morphuntion. This is retrievable using the getCleanValue() function.
 *
 ...
 *
 * <h3> Other tokens </h3>
 * This class is meant to be overridden with classes that have more specific lexical meaning. Morphuntion provides
 ...
 */
class MORPHUNTION_INTERNAL_API morphuntion::tokenizer::Token
    : public virtual CharRange
{
public:
    typedef ::morphuntion::tokenizer::CharRange super;
...
public:
     ...
     */
    bool operator==(const ::morphuntion::tokenizer::Token& rhs) const;
    /**
     ...
     */
    std::size_t operator()(const morphuntion::tokenizer::Token& token) const noexcept;
