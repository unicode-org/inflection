...
public class InflectionPattern {
    ...
    private static Map<Class<?>, String> createEnumToAttribute()
    {
        ...
        result.put(Grammar.Count.class, "number");
        ...
        result.put(Grammar.Objectivity.class, ""); // object
        ...
        result.put(Grammar.Miscellaneous.class, "");
        result.put(Grammar.LemmaCategory.class, "");
        return result;
    }
