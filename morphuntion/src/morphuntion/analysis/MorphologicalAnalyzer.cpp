...
using ::morphuntion::dictionary::Inflector_Inflection;

namespace morphuntion::analysis {

::std::vector<int64_t> MorphologicalAnalyzer::convertLemmaAttributes(const ::morphuntion::dictionary::DictionaryMetaData& dictionary, const ::std::vector<::std::u16string_view> &lemmaAttributes)
{
...
static ::std::vector<::std::vector<int64_t>> convertGrammemePriorities(const ::morphuntion::dictionary::DictionaryMetaData& dictionary, const std::vector<::std::vector<std::u16string_view>> &grammemePriorityStringTables)
{
...
static ::std::vector<int64_t> convertIgnoreGrammemes(const ::morphuntion::dictionary::DictionaryMetaData& dictionary, const ::std::vector<::std::vector<::std::u16string>> &ignoreGrammemeSets)
{
    ::std::vector<int64_t> result;
...
MorphologicalAnalyzer::MorphologicalAnalyzer(const morphuntion::util::ULocale &locale, const ::std::vector<::std::u16string_view> &lemmaAttributes, const std::vector<::std::vector<std::u16string_view>> &grammemePriorityStringTables, const ::std::vector<::std::vector<::std::u16string>> &ignoreGrammemeSets)
