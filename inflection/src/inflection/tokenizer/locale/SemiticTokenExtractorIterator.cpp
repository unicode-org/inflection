...
SemiticTokenExtractorIterator::SemiticTokenExtractorIterator(const ::inflection::tokenizer::locale::SemiticWordAndDelimiterTokenExtractor& decompounder, std::u16string_view str)
