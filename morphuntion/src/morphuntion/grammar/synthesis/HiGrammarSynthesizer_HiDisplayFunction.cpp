...
using morphuntion::dialog::SemanticFeatureModel;
...
using morphuntion::util::Validate;
using morphuntion::tokenizer::TokenizerFactory;
...
HiGrammarSynthesizer_HiDisplayFunction::HiGrammarSynthesizer_HiDisplayFunction(const SemanticFeatureModel& model)
    ...
    , tokenizer(TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::HINDI()))
...
::std::optional<::std::u16string> HiGrammarSynthesizer_HiDisplayFunction::inflectTokenChain(const ::morphuntion::tokenizer::TokenChain& tokenChain, const ::std::map<SemanticFeature, ::std::u16string> &constraints, bool enableInflectionGuess) const {
