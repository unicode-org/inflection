...
file(GLOB_RECURSE INFLECTION_CPP_HEADERS "${HEADER_DIR}/*.h" "${HEADER_DIR}/*.hpp")
file(GLOB_RECURSE INFLECTION_C_HEADERS "${HEADER_DIR}/*.h")
...
compile_headers(${CPP_COMPILER_BIN} "${CXX_CHECK_HEADER_FLAGS};-std=c++${CXX_STANDARD}" "${HEADER_INCLUDES}" "c++" "${INFLECTION_CPP_HEADERS}")
compile_headers(${C_COMPILER_BIN} "-std=c11" "${HEADER_INCLUDES}" "c" "${INFLECTION_C_HEADERS}")
