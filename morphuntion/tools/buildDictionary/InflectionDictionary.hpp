...
public:
    explicit InflectionDictionary(const ::morphuntion::util::ULocale &locale, const Inflector_InflectionDictionary &dictionary, bool addAffixPatternMappings); // load from dictionary
    ...
    static Inflector_InflectionDictionary* readXML(const ::morphuntion::util::ULocale& locale,
                                                   const std::string& source,
                                                   const std::map<::std::u16string_view, int32_t>& grammemeStringIndices);

private:
    static Inflector_InflectionDictionary* getInflectionPatterns(const ::morphuntion::util::ULocale& locale, xmlDocPtr xmlDoc,
                                                                 const std::map<::std::u16string_view, int32_t>& grammemeStringIndices);
