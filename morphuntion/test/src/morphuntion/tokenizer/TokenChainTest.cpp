...
TEST_CASE("TokenChainTest#testTokenChain") /* throws(Exception) */
{
    ...
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tokenChain(tokenizer->createTokenChain(u"hey siri how are you. I like to use \"quoted tokens\"!"));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> newTokenChain(tokenChain->getNewTokenChain(9, npc(tokenChain->getEnd())->getEndChar()));
...
TEST_CASE("TokenChainTest#withStartCharNonZero")
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::US()));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tokenChain(tokenizer->createTokenChain(u"hey siri how are you. I like to use \"quoted tokens\"!"));
    ::std::unique_ptr<::morphuntion::tokenizer::Chunk> subChunk(tokenChain->getSubChunk(9, 16));
...
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::US()));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tokenChain(tokenizer->createTokenChain(u""));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> newTokenChain(tokenChain->getNewTokenChain(0, npc(tokenChain->getEnd())->getEndChar()));
...
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::US()));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tokenChain(tokenizer->createTokenChain(u"Test"));
...
TEST_CASE("TokenChainTest#testTokenChainEquality") /* throws(Exception) */
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::US()));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tokenChain(tokenizer->createTokenChain(u"hey siri how are you. I like to use \"quoted tokens\"!"));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> secondChain(tokenizer->createTokenChain(u"hey siri how are you. I like to use \"quoted tokens\"!"));
...
TEST_CASE("TokenChainTest#testTokenChainInequality") /* throws(Exception) */
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::US()));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tokenChain(tokenizer->createTokenChain(u"hey siri how are you. I like to use \"quoted tokens\"!"));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> nonMatching(tokenizer->createTokenChain(u"Hey Siri how are you. I like to use \"quoted tokens\"!"));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> otherNonMatching(tokenizer->createTokenChain(u"Hey Siri how is the weather today."));
...
{
    ::std::unique_ptr<::morphuntion::tokenizer::Tokenizer> tokenizer(::morphuntion::tokenizer::TokenizerFactory::createTokenizer(::morphuntion::util::LocaleUtils::US()));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> emptyChain(tokenizer->createTokenChain(u""));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> otherEmpty(tokenizer->createTokenChain(u""));
    REQUIRE(*emptyChain == *otherEmpty);
    REQUIRE_FALSE(*emptyChain != *otherEmpty);
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> spaceChain(tokenizer->createTokenChain(u" "));
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> periodChain(tokenizer->createTokenChain(u"."));
...
TEST_CASE("TokenChainTest#testToString")
{
    ...
    tk->setStyle(morphuntion::tokenizer::Tokenizer::DEFAULT);
    ::std::unique_ptr<::morphuntion::tokenizer::TokenChain> tokChain(tk->createTokenChain(u"A test?"));
...
{
    std::unique_ptr<morphuntion::tokenizer::Tokenizer> tokenizer(morphuntion::tokenizer::TokenizerFactory::createTokenizer(morphuntion::util::LocaleUtils::US()));
    std::unique_ptr<morphuntion::tokenizer::TokenChain> chain1(tokenizer->createTokenChain(u"hey siri how are you. I like to use \"quoted tokens\"!"));
    std::unique_ptr<morphuntion::tokenizer::TokenChain> chain2(tokenizer->createTokenChain(u"hey siri how are you. I like to use \"quoted tokens\"!"));

    std::set<morphuntion::tokenizer::TokenChain*> s;
    s.insert(chain1.get());
    s.insert(chain2.get());
