 ...
 */
template <typename T>
class morphuntion::dictionary::metadata::MarisaTrie {
public:
    ...
    static inline const char * getEncodingName(EncodingEnum encodingEnum) {
        switch (encodingEnum) {
            ...
            case UTF16LE:
                return "UTF16LE";
            default:
                throw ::morphuntion::exception::IllegalStateException(u"Unknown encoding value " + ::morphuntion::util::StringUtils::to_u16string(encodingEnum));
        }
    }
    ...
    morphuntion::dictionary::metadata::MarisaTrieIterator<T> getAllWithPrefix(std::u16string_view prefix) const;
    ...
    explicit MarisaTrie(::morphuntion::util::MemoryMappedFile* mappedFile);
    ~MarisaTrie();
...
private:
    ...
    MarisaTrie(::morphuntion::util::MemoryMappedFile* mappedFile, int32_t trieSize);
    MarisaTrie(::morphuntion::util::MemoryMappedFile* mappedFile, int32_t trieSize, EncodingEnum encodingEnum);
...
template <typename T>
morphuntion::dictionary::metadata::MarisaTrie<T>::MarisaTrie(const ::std::map<::std::u16string_view, T>& input, FieldMetrics fieldMetrics)
...
template <typename T>
morphuntion::dictionary::metadata::MarisaTrie<T>::MarisaTrie(const ::std::map<::std::u16string_view, T>& input)
    : MarisaTrie(input, getFieldMetrics(input))
{
}

template <typename T>
morphuntion::dictionary::metadata::MarisaTrie<T>::MarisaTrie(::morphuntion::util::MemoryMappedFile* mappedFile, int32_t trieSize, EncodingEnum encodingEnum)
...
template <typename T>
morphuntion::dictionary::metadata::MarisaTrie<T>::MarisaTrie(::morphuntion::util::MemoryMappedFile* mappedFile, int32_t trieSize)
    : MarisaTrie(mappedFile, trieSize, (EncodingEnum)util::Validate::notNull(mappedFile)->read<int16_t>())
{
}

template <typename T>
morphuntion::dictionary::metadata::MarisaTrie<T>::MarisaTrie(::morphuntion::util::MemoryMappedFile* mappedFile)
    : MarisaTrie(mappedFile, util::Validate::notNull(mappedFile)->read<int32_t>())
{
}

template <typename T>
morphuntion::dictionary::metadata::MarisaTrie<T>::~MarisaTrie()
{
}

template<typename T>
typename morphuntion::dictionary::metadata::MarisaTrie<T>::FieldMetrics
morphuntion::dictionary::metadata::MarisaTrie<T>::getFieldMetrics(const std::map<::std::u16string_view, T> &input) {
    // Find the most efficient encoding
    morphuntion::dictionary::metadata::CharsetConverter encodeBOCU1(getEncodingName(BOCU1));
    ::std::string encoded;
...
template <typename T>
::std::u16string morphuntion::dictionary::metadata::MarisaTrie<T>::getKey(int32_t id) const
{
...
template <typename T>
int32_t morphuntion::dictionary::metadata::MarisaTrie<T>::getKeyId(std::u16string_view key) const
{
    ::std::string encoded;
    ::marisa::Agent agent;
...
template <typename T>
T morphuntion::dictionary::metadata::MarisaTrie<T>::find(int32_t id) const
{
    return data.read(id);
}

template <typename T>
std::optional<T> morphuntion::dictionary::metadata::MarisaTrie<T>::find(std::u16string_view key) const
{
...
template <typename T>
void morphuntion::dictionary::metadata::MarisaTrie<T>::write(::std::ostream& writer) const
{
...
template <typename T>
morphuntion::dictionary::metadata::MarisaTrieIterator<T>
morphuntion::dictionary::metadata::MarisaTrie<T>::getAllWithPrefix(std::u16string_view prefix) const
{
    return MarisaTrieIterator<T>(*this, prefix);
}

template <typename T>
int32_t morphuntion::dictionary::metadata::MarisaTrie<T>::getSize() const
{
    return trie.size();
}
