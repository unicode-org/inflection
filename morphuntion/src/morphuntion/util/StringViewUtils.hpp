 ...
 */
class MORPHUNTION_INTERNAL_API StringViewUtils {
public:
    /**
     ...
     */
    static ::std::u16string capitalizeFirst(std::u16string_view string, const ::morphuntion::util::ULocale& locale);
    /**
     ...
     */
    static ::std::u16string* uppercase(::std::u16string* dest, std::u16string_view src, const ::morphuntion::util::ULocale& locale);
    /**
     ...
     * @return A pointer to the destination string.
     */
    static ::std::u16string* lowercase(::std::u16string* dest, std::u16string_view src, const ::morphuntion::util::ULocale& locale);
