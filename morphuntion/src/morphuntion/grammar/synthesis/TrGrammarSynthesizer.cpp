...
{
    static auto SEPARATOR_SPLITTER_ = ::morphuntion::util::UnicodeSetUtils::freeze(new ::icu4cxx::UnicodeSet(u"[/:[:whitespace:]]"));
    return *npc(SEPARATOR_SPLITTER_);
}

const ::icu4cxx::UnicodeSet& TrGrammarSynthesizer::ENDING_SINGLE_QUOTE()
{
    static auto ENDING_SINGLE_QUOTE_ = ::morphuntion::util::UnicodeSetUtils::freeze(new ::icu4cxx::UnicodeSet(u"['’]"));
    return *npc(ENDING_SINGLE_QUOTE_);
}

const ::icu4cxx::UnicodeSet& TrGrammarSynthesizer::ENDING_DOUBLE_QUOTE()
{
    static auto ENDING_DOUBLE_QUOTE_ = ::morphuntion::util::UnicodeSetUtils::freeze(new ::icu4cxx::UnicodeSet(u"[\"”]"));
    return *npc(ENDING_DOUBLE_QUOTE_);
}
void TrGrammarSynthesizer::addSemanticFeatures(::morphuntion::dialog::SemanticFeatureModel& featureModel)
{
