...
const ::morphuntion::util::ULocale& LocaleUtils::BULGARIAN()
{
    static auto BULGARIAN_ = new ULocale("bg");
    return *npc(BULGARIAN_);
}

const ::morphuntion::util::ULocale& LocaleUtils::BULGARIA()
{
...
{
    static auto BASE_SUPPORTED_LOCALES_ = createSupportedLocaleMapToBase(morphuntion::resources::DataResource::getProperties(u"/org/unicode/morphuntion/locale/supported-locales.properties"), LOCALE_SUPPORT_GROUP_);
...
static ::std::map<ULocale, ::std::pair<ULocale, ULocale>>* initFALLBACK_PAIR_LOCALES()
{
    ...
    auto fallbackMappings = morphuntion::resources::DataResource::getProperties(u"/org/unicode/morphuntion/locale/fallback-locales.properties");
