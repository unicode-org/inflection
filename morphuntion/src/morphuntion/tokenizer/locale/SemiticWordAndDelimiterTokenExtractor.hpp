...
class morphuntion::tokenizer::locale::SemiticWordAndDelimiterTokenExtractor final
...
public:
    morphuntion::tokenizer::iterator::TokenExtractorIterator* createIterator(std::u16string_view str) const override;
...
public:
    SemiticWordAndDelimiterTokenExtractor(const ::morphuntion::util::ULocale& locale, const ::icu4cxx::UnicodeSet& nativeSet, const ::std::map<::std::u16string_view, const char16_t*>& config);
