 ...
 */
// Forward declarations for morphuntion.dialog.language
#pragma once
...
namespace morphuntion
{
    namespace dialog
    {
        //! Contains all CommonConceptFactories in Morphuntion. Useful for creating dialogs based on semantic constraints and more.
        namespace language
        {
