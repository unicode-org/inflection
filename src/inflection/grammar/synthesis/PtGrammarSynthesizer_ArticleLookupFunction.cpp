...
PtGrammarSynthesizer_ArticleLookupFunction::PtGrammarSynthesizer_ArticleLookupFunction(const ::inflection::dialog::SemanticFeatureModel& model,
    ...
    , derivedArticleFeature((derivedSemanticName != nullptr ? model.getFeature(derivedSemanticName) : static_cast< ::inflection::dialog::SemanticFeature* >(nullptr)))
    , numberFeature(model.getFeature(GrammemeConstants::NUMBER))
...
PtGrammarSynthesizer_ArticleLookupFunction::PtGrammarSynthesizer_ArticleLookupFunction(const ::inflection::dialog::SemanticFeatureModel& model, const ::std::u16string& derivedSemanticName, const PtGrammarSynthesizer_ArticleLookupFunction& other)
    : PtGrammarSynthesizer_ArticleLookupFunction(model, other.numberLookupFunction, other.genderLookupFunction, derivedSemanticName.c_str(), other.defaultString, other.defaultSingularString, other.defaultPluralString, other.singularMasculineString, other.singularFeminineString, other.pluralMasculineString, other.pluralFeminineString)
{
}
...
inflection::dialog::SpeakableString* PtGrammarSynthesizer_ArticleLookupFunction::getFeatureValue(const ::inflection::dialog::DisplayValue& displayValue, const ::std::map<::inflection::dialog::SemanticFeature, ::std::u16string>& /*constraints*/) const
{
    ...
    auto countValue = PtGrammarSynthesizer::getNumber(displayValue.getFeatureValue(*npc(numberFeature)));
