...
private:
    ...
    std::optional<::std::pair<::std::u16string, ::std::u16string>> inflectDeterminerAndNoun(const ::std::u16string &determiner, const ::std::u16string &noun, const ::std::map<::inflection::dialog::SemanticFeature, ::std::u16string>& constraints, bool enableInflectionGuess) const;

    ::std::optional<::std::u16string> inflectAdjectiveNextToNoun(const ::std::u16string &adjective, const ::std::map<::inflection::dialog::SemanticFeature, ::std::u16string> &constraints, const ::std::u16string &nounAfterInflection) const;
