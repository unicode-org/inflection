 ...
 *
 * @see morphuntion::analysis::ConfigurableAnalyzer
 */
class MORPHUNTION_INTERNAL_API morphuntion::tokenizer::Tokenizer
...
private:
    typedef void (*modifyTokens)(const ::morphuntion::tokenizer::Tokenizer* tokenizer, std::u16string_view originalInput, morphuntion::tokenizer::Token_Head* head);
...
protected: /* protected */
    explicit Tokenizer(const ::morphuntion::tokenizer::TokenExtractor* wordExtractor);
