 ...
 */
class MORPHUNTION_INTERNAL_API morphuntion::dictionary::metadata::StringArrayContainer {
private:
    int32_t arraySize {  };
...
public:
    ...
    explicit StringArrayContainer(morphuntion::util::MemoryMappedFile *mappedFile);
