...
class morphuntion::grammar::synthesis::ArGrammarSynthesizer_ToPrepositionLookupFunction
...
public: /* package */
    ...
    explicit ArGrammarSynthesizer_ToPrepositionLookupFunction(const ::morphuntion::dialog::SemanticFeatureModel& model);
};
