...
{
    auto dictionary = morphuntion::dictionary::DictionaryMetaData::createDictionary(::morphuntion::util::LocaleUtils::US());
...
TEST_CASE("DictionaryMetaDataTest#testUnknown")
{
    ...
    auto dictionary = morphuntion::dictionary::DictionaryMetaData::createDictionary(::morphuntion::util::ULocale("tlh"));
    ...
    dictionary = morphuntion::dictionary::DictionaryMetaData::createDictionary(::morphuntion::util::ULocale("en_US"));
...
{
    auto dictionary = morphuntion::dictionary::DictionaryMetaData::createDictionary(::morphuntion::util::LocaleUtils::KOREA());
...
{
    auto dictionary = morphuntion::dictionary::DictionaryMetaData::createDictionary(::morphuntion::util::LocaleUtils::TURKISH());
...
{
    auto dictionary = morphuntion::dictionary::DictionaryMetaData::createDictionary(::morphuntion::util::LocaleUtils::RUSSIAN());
...
{
    auto dictionary = morphuntion::dictionary::DictionaryMetaData::createDictionary(::morphuntion::util::LocaleUtils::GERMAN());
    int64_t grammemes = 0;
...
{
    auto dictionary = morphuntion::dictionary::DictionaryMetaData::createDictionary(::morphuntion::util::LocaleUtils::ENGLISH());
...
TEST_CASE("DictionaryMetaDataTest#testPropertyNames")
{
    ...
    for (const auto& localeEntry : morphuntion::util::LocaleUtils::getSupportedLocaleMap()) {
        morphuntion::util::ULocale language(localeEntry.first);
        ...
        for (const auto& propertyName : dictionary->getPropertyNames(-1)) {
            if (propertyName.find(u':') != std::u16string::npos) {
                FAIL_CHECK(language.getName() + " should not contain a colon for the property " + morphuntion::util::StringUtils::to_string(propertyName));
            }
        }
    }
}
...
{
    auto fallbackDictionary = morphuntion::dictionary::DictionaryMetaData::createDictionary(::morphuntion::util::LocaleUtils::US());
    auto fallbackWordsItr = npc(fallbackDictionary)->getKnownWords();
    REQUIRE(fallbackWordsItr != fallbackWordsItr.end());
    auto expectedDictionary = morphuntion::dictionary::DictionaryMetaData::createDictionary(::morphuntion::util::LocaleUtils::GREAT_BRITAIN());
