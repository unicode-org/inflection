...
public:
    ...
    static const dialog::SemanticFeatureModel_DisplayValue* getTheBestDisplayValue(const ::inflection::dialog::SemanticFeatureModel_DisplayData& displayData, const ::std::map<::inflection::dialog::SemanticFeature, ::std::u16string>& constraints);
    static ::std::map<::inflection::dialog::SemanticFeature, ::std::u16string> mergeConstraintsWithDisplayValue (const ::inflection::dialog::SemanticFeatureModel_DisplayValue& displayValue, const ::std::map<::inflection::dialog::SemanticFeature, ::std::u16string>& constraints);
