...
class morphuntion::grammar::synthesis::ArGrammarSynthesizer_AsPrepositionLookupFunction
...
public: /* package */
    ...
    explicit ArGrammarSynthesizer_AsPrepositionLookupFunction(const ::morphuntion::dialog::SemanticFeatureModel& model);
};
