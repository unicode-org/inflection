...
class morphuntion::grammar::synthesis::TrGrammarSynthesizer_DeConjunctionArticleLookupFunction
...
public:
    ...
    TrGrammarSynthesizer_DeConjunctionArticleLookupFunction(const ::morphuntion::dialog::SemanticFeatureModel& model, const TrGrammarSynthesizer_TrDisplayFunction* displayFunctionUtility);
};
