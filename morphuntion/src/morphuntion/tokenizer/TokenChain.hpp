...
#include <morphuntion/tokenizer/Chunk.hpp>
#include <string>
#include <vector>
 ...
 */
class MORPHUNTION_INTERNAL_API morphuntion::tokenizer::TokenChain
    : public morphuntion::tokenizer::Chunk
{
public:
    typedef Chunk super;
...
public:
     ...
     */
    bool operator==(const morphuntion::tokenizer::TokenChain& rhs) const;
    /**
     ...
     */
    std::size_t operator()(const morphuntion::tokenizer::TokenChain& tokenChain) const noexcept;
    /**
