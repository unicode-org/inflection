 ...
 */
class MORPHUNTION_CLASS_API morphuntion::util::ULocale
...
public:
     ...
     */
    ULocale(const ::morphuntion::util::ULocale& other);
     ...
     * @return      *this
     */
    ::morphuntion::util::ULocale& operator=(const ::morphuntion::util::ULocale& other);
     ...
     */
    bool   operator==(const    ::morphuntion::util::ULocale&     other) const;
     ...
     */
    std::size_t operator()(const morphuntion::util::ULocale& locale) const noexcept;
...
inline bool
morphuntion::util::ULocale::operator==(const ::morphuntion::util::ULocale& other) const
{
...
morphuntion::util::ULocale::getCountry() const
{
    return country;
}
...
inline ::std::string_view
morphuntion::util::ULocale::getScript() const
{
    return script;
}

inline ::std::string_view
morphuntion::util::ULocale::getVariant() const
{
    return variant;
}

inline const ::std::string &
morphuntion::util::ULocale::getName() const
{
    return fullName;
}
