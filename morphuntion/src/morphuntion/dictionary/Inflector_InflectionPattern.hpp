...
class morphuntion::dictionary::Inflector_InflectionPattern final
{
private: /* package */
    ...
    const ::morphuntion::dictionary::Inflector_MMappedDictionary& inflectorDictionary;
    const ::morphuntion::dictionary::metadata::StringContainer& suffixes {  };
...
public:
    ...
    ::std::vector<::morphuntion::dictionary::Inflector_Inflection> inflectionsForSurfaceForm(::std::u16string_view surfaceForm, int64_t fromGrammemes) const;
