...
{
public:
    static Dictionary* setupDictionary(const ::morphuntion::util::ULocale& locale, const ::std::string& sourcePath, const ::std::string& additionalSourcePath);
...
private:
    ...
    Dictionary(const ::morphuntion::util::ULocale& locale);
public:
    ~Dictionary();
};
