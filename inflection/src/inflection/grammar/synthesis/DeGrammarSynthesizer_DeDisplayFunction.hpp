...
private:
    ...
    static ::std::u16string inflectGenitiveProperNoun(const ::std::u16string &displayString);
...
public: /* package */
    explicit DeGrammarSynthesizer_DeDisplayFunction(const ::inflection::dialog::SemanticFeatureModel& model);
