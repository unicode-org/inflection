...
public: /* package */
    ...
    ArGrammarSynthesizer_ToPrepositionLookupFunction(const ArGrammarSynthesizer_ToPrepositionLookupFunction&) = delete;
    ArGrammarSynthesizer_ToPrepositionLookupFunction& operator=(const ArGrammarSynthesizer_ToPrepositionLookupFunction&) = delete;
};
