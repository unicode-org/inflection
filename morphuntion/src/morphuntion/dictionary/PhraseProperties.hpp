 ...
 */
class MORPHUNTION_INTERNAL_API morphuntion::dictionary::PhraseProperties final
{
public:
    /**
     ...
     */
    static bool isStartsWithVowel(const ::morphuntion::util::ULocale& loc, ::std::u16string_view str);
    /**
     ...
     */
    static bool isEndsWithVowel(const ::morphuntion::util::ULocale& loc, ::std::u16string_view str);
    /**
